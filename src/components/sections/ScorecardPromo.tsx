  ...
  return (
    <section className="bg-surface py-16 md:py-24">
      <div className="container-page">
        <ScrollReveal>
          <div className="flex flex-col items-start gap-8 rounded-[20px] bg-white p-8 shadow-[0_1px_3px_rgba(20,20,26,0.04)] sm:p-12 lg:flex-row lg:items-center lg:justify-between">
